---
name: "exportar-y-verificar"
description: "Exportar y verificar versiones del RAM con trazabilidad."
---
...
- `.agents/checklists/antes_de_exportar.md`
- `.agents/plantillas/informe.md`
- `.agents/plantillas/propuesta.md`
